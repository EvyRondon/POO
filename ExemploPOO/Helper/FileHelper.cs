...
namespace ExemploPOO.Helper
{
  public class FileHelper
  {
    ...
    public void CriarAquivoStream(string caminho, List<string> conteudo)
    {
    ...
    public void CopiarArquivo(string caminhoOrigem, string caminhoDestino, bool sobrescrever)
    {
